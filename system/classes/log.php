...
class Log {
    ...
    public function attach(Log_Writer $writer, $levels = array(), $min_level = 0) {
        ...
        $this->_writers["{$writer}"] = array('object' => $writer, 'levels' => $levels);
    ...
    public function add($level, $message, array $values = NULL) {
        ...
        $this->_messages[] = array('time' => Date::formatted_time('now', Log::$timestamp, Log::$timezone), 'level' => $level, 'body' => $message, );
